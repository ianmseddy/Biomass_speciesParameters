...
the latter two in conjunction with the module *Biomass_borealDataPrep*.
...
combinations of traits. `maxBiomass` was held constant at 5000, however  
...
**Spatial layers**
    ...
    -   `studyAreaANPP` -- shapefile. A `sf` or `SpatVector` deterfmining where 
     the geographic extent of the PSP data. 
